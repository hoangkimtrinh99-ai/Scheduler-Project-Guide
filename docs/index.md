...
Welcome to the comprehensive Scheduler setup and user guide. This documentation will walk you through the complete process of setting up and using the Scheduler system.
...
- Admin can login to the admin portal
...
- [Rooms & Equipment](setup/rooms-equipment.md)  
- [Specialization & Skills](setup/specialization-skills.md)  
- [Branch Hours](setup/branch-hours.md)  
- [Shift Templates](setup/staff-shift-template.md)  
- [Branch Rooms](setup/branch-room.md)  
- [Branch Equipment](setup/branch-equipment.md)  
- [Service Categories](setup/service-category.md)  
- [Services](setup/service.md)  
- [Staff](setup/staff.md)  
- [Schedules](setup/staff-schedules.md)
